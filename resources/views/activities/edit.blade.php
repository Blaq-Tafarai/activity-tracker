            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 px-4 pb-4 lg:grid-cols-2 gap-4 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="submit" form="update-form" class="inline-flex items-center px-6 py-3 bg-blue-500 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-all duration-200">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
